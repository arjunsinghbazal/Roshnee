...
import imgae3 from "https://www.vecteezy.com/png/36473296-ai-generated-happy-old-man-with-a-kind-expression-on-a-transparent-background"; // Corrected URL
...
const Home = () => {
  ...
  const images = [imgae, imgae1, imgae2, imgae3]; // Added fourth image
    ...
    <div className="container">
      ...
      <div className="recomended" ref={recommendedRef}>
        <div className="onerec">
          <h3>Recommended</h3>
          <button className="gray" onClick={handleCartClick}>
            See all
          </button>
        </div>
            ...
            filteredEyewear
              ...
              .map((item, index) => (
                <div className="items" key={index}>
                  <img src={item.eyewearLink} alt="eyewear" />
                  <h5>{item.name}</h5>
